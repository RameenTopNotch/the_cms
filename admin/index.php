        ...
        <div id="wrapper">
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class='huge'><?php echo $posts_no; ?></div>
                                            <div>Posts</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-green">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class='huge'><?php echo $comments_no; ?></div>
                                            <div>Comments</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-yellow">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class='huge'><?php echo $users_no; ?></div>
                                            <div> Users</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-red">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class='huge'><?php echo $categories_no; ?></div>
                                            <div>Categories</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- The chart -->
                    <div class="container" id="top_x_div" style="width: 800px; height: 600px;"></div>
